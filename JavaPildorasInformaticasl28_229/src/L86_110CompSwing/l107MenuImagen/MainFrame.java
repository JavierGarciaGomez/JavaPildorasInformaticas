package L86_110CompSwing.l107MenuImagen;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame(){
        ...
        menuEdit.add(new JMenuItem("Copy", new ImageIcon( "resources\\copy.png")));
        menuEdit.add(new JMenuItem("Paste", new ImageIcon( "resources\\paste.png")));;
